...
def test_plugin_contract(tmp_path: Path):
    ...
    try:
        ...
        assert_true(describe["result"]["version"] == "0.2.5", "describe should advertise the current tool version")
...
def test_bundle_contract():
    ...
    assert_true(manifest["required_executas"][0]["min_version"] == "0.2.5", "manifest should require tool 0.2.5")
