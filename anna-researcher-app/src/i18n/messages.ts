export const messages = {
  "zh-CN": {
    ...
    startButtonBusy: "研究中",
    settingsAria: "研究设置",
    settingsTitle: "Tavily 设置",
    settingsMissing: "需要先保存 Tavily API Key 才能开始网页研究。",
    settingsConfigured: "Tavily 已配置。",
    tavilyKeyLabel: "Tavily API Key",
    tavilyKeyPlaceholder: "输入 Tavily API Key",
    saveSettingsButton: "保存 Key",
    clearSettingsButton: "清除 Key",
    statusAria: "研究状态",
    resultAria: "研究结果",
    idleStageLabel: "空闲",
    emptyMessage: "准备就绪。",
  ...
  en: {
    ...
    settingsTitle: "Tavily Settings",
    settingsMissing: "Save a Tavily API key before starting web research.",
    settingsConfigured: "Tavily is configured.",
    tavilyKeyLabel: "Tavily API Key",
    tavilyKeyPlaceholder: "Enter Tavily API key",
    saveSettingsButton: "Save Key",
    clearSettingsButton: "Clear Key",
